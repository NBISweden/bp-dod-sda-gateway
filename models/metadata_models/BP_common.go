// Package metadata_models: file contains go representation of xsd structure: https://github.com/imi-bigpicture/bigpicture-metaflex/blob/2.0.0/src/BP.common.xsd
...
func (a *Attributes) Equal(compare *Attributes) bool {
	...
	for i, ca := range a.CodeAttributes {
	...
	for i, sa := range a.SetAttributes {
...
func (ca *CodeAttributeValue) Equal(compare *CodeAttributeValue) bool {
	...
	return ca.SchemeVersion.Equal(compare.SchemeVersion)
}
	...
	if ns.Nil {
		start.Attr = append(start.Attr,
			xml.Attr{
				...
				Value: "http://www.w3.org/2001/XMLSchema-instance", // nolint:revive
			},
			xml.Attr{
				Name: xml.Name{
					Local: "xsi:nil",
...
func (ncav *NullableCodeAttributeValue) Equal(compare *NullableCodeAttributeValue) bool {
	if (compare == nil && ncav != nil) ||
		(compare != nil && ncav == nil) {
		return false
	}
	if compare == nil {
		// Both are nil
	...
	return ncav.Value.Equal(compare.Value)
}

func (ncav *NullableCodeAttributeValue) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if ncav.Nil {
		start.Attr = append(start.Attr,
			xml.Attr{
				Name: xml.Name{
	...
	return e.EncodeElement(*ncav.Value, start)
}

func (ncav *NullableCodeAttributeValue) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	for _, a := range start.Attr {
		// nolint:revive
		if a.Name.Space == "http://www.w3.org/2001/XMLSchema-instance" &&
			a.Name.Local == "nil" &&
...
func (nca *NullableCodeAttributes) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if nca.Nil {
		start.Attr = append(start.Attr,
			xml.Attr{
				Name: xml.Name{
	...
	return e.EncodeElement(*nca.Value, start)
}

func (nca *NullableCodeAttributes) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	for _, a := range start.Attr {
		// nolint:revive
		if a.Name.Space == "http://www.w3.org/2001/XMLSchema-instance" &&
			a.Name.Local == "nil" &&
